...
const ServedOrdersPage = () => {
  ...
  const confirmStatusUpdate = async () => {
    ...
    try {
      const response = await ordersApi.updateToCompleted(statusConfirm.orderId);
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            View and manage served orders (Dine-in only)
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
        {orders.length === 0 ? (
          <div className="px-6 py-12 text-center">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No served orders found</h3>
            <p className="text-gray-500 dark:text-gray-400">No served orders available at the moment.</p>
          </div>
        ) : (
